...
//		}
	...
	private function getDBdat($path) {		
		...
		if($path == '/'){
		//$root = array();	
			//$root = ['id'=>NULL, 'name'=>'', 'size'=>'', 'modifiedTime'=>NULL, 'mimeType'=>'application/vnd.google-apps.folder', 'parents'=>'', 'read'=>'1', 'write'=>'1', 'locked'=>'0', 'hidden'=>'0', 'width'=>NULL, 'height'=>NULL, 'webContentLink'=>NULL,'thumbnailLink'=>''];
