 ...
 * Version 2.1.37 (2.1-src Nightly: e12c05d) (2018-05-01)
 * http://elfinder.org
 * 
	...
	getSize : function(targets) {
		...
		cache().done(function() {
			...
			$.when.apply($, dfds).fail(function() {
				...
				if (dirCnt !== false){
					cnts.push(self.i18n('folders') + ': ' + (dirCnt - (targets.length > 1? 0 : 1)));
				}
				if (fileCnt !== false){
 ...
 * @type String
 **/
elFinder.prototype.version = '2.1.37 (2.1-src Nightly: e12c05d)';
