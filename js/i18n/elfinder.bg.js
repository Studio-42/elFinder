...
(function(root, factory) {
	...
	elFinder.prototype.i18.bg = {
		...
		messages   : {
			...
			'emptySearch'     : 'Резултатите от търсенето са празни за целта на търсене.', // from v2.1.12 added 5.16.2016
			...
			'emptyIncSearch'  : 'Резултатите от търсенето са празни в текущия изглед.\\AНатиснете [Enter] за да разширите целта за търсене.', // from v2.1.16 added 5.10.2016
